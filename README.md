...
- Similarly, if you have a laptop with an older TB chip, e.g., Intel JHL6540, the connection does not support two DP streams, thus you can use only one of the MSTs at a time. When switching between MSTs, you may also need to power off the Dock completely first.
